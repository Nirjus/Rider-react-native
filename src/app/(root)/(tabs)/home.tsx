            ...
            {!loading ? (
              <>
                <Image
                  ...
                  resizeMode="contain"
                />
                <Text className=" text-sm font-Parkinsans">
                  No resent text found
                </Text>
              </>
            ) : (
        ...
        ListHeaderComponent={() => (
          <>
            <View className=" flex flex-row items-center justify-between my-5">
              <Text className=" text-xl font-ParkinsansBold">
                welcome {user?.name} 👋
              </Text>
              <TouchableOpacity
            ...
            />
            <>
              <Text className=" text-xl font-ParkinsansBold mt-5 mb-3">
